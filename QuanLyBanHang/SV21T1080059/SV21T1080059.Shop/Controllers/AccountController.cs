...
namespace SV21T1080059.Shop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ChangePassword(string oldPassword, string newPassword, string confirmPassword)
        {
            ...
            {
                ModelState.AddModelError("confirmPassword", "Mật khẩu mới và mật khẩu cũ bị trùng");
                return View();
            }
        ...
        {
            // Lưu dữ liệu vào ViewData để hiển thị lại
            ...
            {
                ModelState.AddModelError("Username", "Vui lòng nhập địa chỉ email hợp lệ");
                return View("SignUp");
            }
            ...
            try
            {
                ...
                if (id <= 0)
                {
                    ModelState.AddModelError("Username", "Tên đăng nhập (Email) đã tồn tại");
                    return View("SignUp");
                }
